...
def build_rules() -> list[Rule]:
    ...
    rules = [
        ...
        Rule("lab-vm-name", 4, _bregex(r"(?i)\b(?:Test_Router|Test_Clienta|Test_Client|Test_Client_Legacy|OpenWrt_2026_Router|OpenWrt_LAN_Client|lab_vms)\b"), "VM/lab name", redact=False),
    ]
