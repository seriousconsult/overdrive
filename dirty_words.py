...
def build_rules() -> list[Rule]:
    ...
    rules = [
        ...
        Rule("virtualbox-vm-name", 4, _bregex(r"(?i)\b(?:Test_Router|Test_Clienta|Test_Client|Test_Client_Legacy|OpenWrt_2026_Router|OpenWrt_LAN_Client|VirtualBox VMs)\b"), "VM/lab name", redact=False),
    ]
