...
class ClientPrimeAssets:
    ...
    launch_identity_init_host: Path
...
def prepare_client_prime_assets(work_root: Path) -> ClientPrimeAssets:
    ...
    launch_identity_init_host = work_root / "overdrive-launch-identity.init"
    launch_identity_init_host.write_text(LAUNCH_IDENTITY_INIT_ALPINE, encoding="utf-8", newline="\n")
    ...
    return ClientPrimeAssets(
        ...
        launch_identity_init_host=launch_identity_init_host,
...
def copy_client_payloads_and_service_assets(
    ...
    *,
    ...
    customize_args = [
        ...
        "--copy-in",
        f"{assets.launch_identity_init_host}:/etc/init.d",
        "--copy-in",
