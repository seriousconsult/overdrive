...
Host-authenticity score:
  1 - No DoH signals found; typical plain DNS / OS resolver.
  2 - Clear or likely DoH; common on home machines but mildly atypical.
  3 - Inconclusive (could not read settings or mixed errors).
  4/5 - Reserved for artificial-host evidence, which this probe does not produce.
"""
